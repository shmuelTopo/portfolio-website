  ...
  return (
    <div className="home">
      ...
      <p className="home-description">
        I am a dedicated and motivated developer, with a strong passion for web development and an
        eagerness to learn and work with new technologies.
      </p>{" "}
      <a
        className="downloadBtn"
        href="https://shmuel.dev/files/resume.pdf"
        download={"resume shmuel toporowitch.pdf"}
        rel="noreferrer"
      >
